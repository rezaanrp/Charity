...
b.toNumber=Math.round(f/a.step)*a.step,n&&(b.fromNumber=parseInt(b.fromNumber*n,10)/n,b.toNumber=parseInt(b.toNumber*n,10)/n));g=b;da()},S=function(){var b={fromNumber:a.from,toNumber:a.to,fromPers:0,toPers:0,fromX:0,fromIdpure:0,toX:0,toIdpure:0},f=a.max-a.min;"single"===a.type?(b.fromPers=(b.fromNumber-a.min)/f*100,b.fromIdpure=B/100*b.fromPers,b.fromX=Math.round(b.fromIdpure),r[0].style.left=b.fromX+"px",c.data(r[0],"x",b.fromIdpure)):"double"===a.type&&(b.fromPers=(b.fromNumber-a.min)/f*100,b.fromIdpure=
B/100*b.fromPers,b.fromX=Math.round(b.fromIdpure),e[0].style.left=b.fromX+"px",c.data(e[0],"x",b.fromIdpure),b.toPers=(b.toNumber-a.min)/f*100,b.toIdpure=B/100*b.toPers,b.toX=Math.round(b.toIdpure),m[0].style.left=b.toX+"px",c.data(m[0],"x",b.toIdpure),M());g=b;da()},da=function(){var b,f,c,z,e,h;h=L/2;"single"===a.type?(a.hideText||(x[0].style.display="none",y[0].style.display="none",c=a.prefix+v(g.fromNumber)+a.postfix,q.html(c),e=q.outerWidth(),h=g.fromX-e/2+h,0>h&&(h=0),h>k-e&&(h=k-e),q[0].style.left=
